 ...
 * below it*. Beside `app/(super-admin)/super-admin/page.tsx` it wrapped
 * all of `/super-admin/*`, so a hard load of `/super-admin/schools` streamed
 * this skeleton first — stat tiles, two charts and a table — then that route's own
