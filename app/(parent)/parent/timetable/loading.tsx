...
/**
 * Loading state for `/parent/timetable`.
 *
 ...
 *
 * The shape mirrors the page it stands in for — the same one
 * `/student/timetable` uses, because it is the same grid. A skeleton that is
 * the wrong shape is worse than none: it promises a layout that then jumps.
 */
