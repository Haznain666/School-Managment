 ...
 * below it*. Beside `app/(teacher)/teacher/page.tsx` it wrapped all of
 * `/teacher/*`, so a hard load of `/teacher/attendance` streamed this skeleton
