...
CREATE TABLE "student_concessions" (
	...
	CONSTRAINT "student_concessions_discount_value_check" CHECK ("student_concessions"."discount_value" >= 0)
);
--> statement-breakpoint
CREATE TABLE "fee_challans" (
	...
	CONSTRAINT "fee_challans_billing_month_check" CHECK ("fee_challans"."billing_month" IS NULL OR "fee_challans"."billing_month" BETWEEN 1 AND 12)
);
--> statement-breakpoint
...
CREATE TABLE "late_fee_rules" (
	...
	CONSTRAINT "late_fee_rules_grace_days_check" CHECK ("late_fee_rules"."grace_days" >= 0),
	CONSTRAINT "late_fee_rules_due_day_check" CHECK ("late_fee_rules"."due_day_of_month" BETWEEN 1 AND 28),
	CONSTRAINT "late_fee_rules_financial_year_month_check" CHECK ("late_fee_rules"."financial_year_start_month" BETWEEN 1 AND 12)
);
--> statement-breakpoint
CREATE TABLE "challan_sequences" (
	...
	CONSTRAINT "challan_sequences_billing_month_check" CHECK ("challan_sequences"."billing_month" BETWEEN 1 AND 12)
);
--> statement-breakpoint
...
CREATE UNIQUE INDEX "fee_challans_student_period_idx" ON "fee_challans" USING btree ("student_profile_id","billing_month","billing_year","academic_year_id");--> statement-breakpoint
CREATE INDEX "fee_challan_items_challan_id_idx" ON "fee_challan_items" USING btree ("challan_id");--> statement-breakpoint
CREATE INDEX "fee_challan_items_location_id_idx" ON "fee_challan_items" USING btree ("location_id");--> statement-breakpoint
...
CREATE INDEX "fee_payments_location_id_payment_date_idx" ON "fee_payments" USING btree ("location_id","payment_date");--> statement-breakpoint
